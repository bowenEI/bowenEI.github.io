...
{{< vexflow id="D-major" title="D 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("D-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="Bb-major" title="Bb 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("Bb-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="A-major" title="A 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("A-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="Eb-major" title="Eb 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("Eb-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="E-major" title="E 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("E-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="Ab-major" title="Ab 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("Ab-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="B-major" title="B 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("B-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="Db-major" title="Db 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("Db-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="Gb-major" title="Gb 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("Gb-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
...
{{< vexflow id="Cb-major" title="Cb 大调音阶" >}}
...
// 动态获取父元素宽度
const div = document.getElementById("Cb-major");
const parentWidth = div.clientWidth;
// 计算每行显示4个小节，调整SVG高度以适应多行显示
const measuresPerRow = 7;
const rowCount = 1;
